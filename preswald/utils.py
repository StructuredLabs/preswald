...
def generate_reddit_like_slug(base_name: str) -> str:
    # Convert base name to lowercase and replace spaces/special chars with hyphens
    ...
    if not validate_slug(slug):
        # If invalid, fallback to a simple format
