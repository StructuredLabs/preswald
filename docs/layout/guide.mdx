...
```python
from preswald import slider, button, download_button
...
# Download button and slider sharing a row
download_button("Download", data, file_name="data.csv", mime_type="text/csv", size=0.5)
slider = slider("Adjust", min_val=0.0, max_val=10.0, default=5.0, size=0.5)
```
