...
text("## Pixar rilms released on or after 2005 with their box office revenue and associated rotten tomatoes score")
threshold = slider("Threshold", min_val=70, max_val=100, default=50)
table(filtered_df[filtered_df["rotten_tomatoes_score"] > threshold], title="Dynamic Data View")

text("## A plot of box office revenue and rotten tomato scores for Pixar rilms released on or after 2005")
