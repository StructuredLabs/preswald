...
#     x='Attendance (%)',
#     y='Final_Score',
#     title='Attendance vs. Final Score (Heatmap)',
...
#
#
# heatmap_fig.update_traces(textposition='top center', marker=dict(size=12, color='lightblue'))
# heatmap_fig.update_layout(
#     template='plotly_white',
#     height=500,  # Limit height to avoid full-screen takeover
#     width=800,
#     title_x=0.5)
# plotly(heatmap_fig)
